...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/tmc/betcoin/integration/rpctest)
...
```bash
$ go get -u github.com/tmc/betcoin/integration/rpctest
```
