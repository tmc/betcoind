...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/tmc/betcoin/peer)
...
```bash
$ go get -u github.com/tmc/betcoin/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/tmc/betcoin/peer#example-package--NewOutboundPeer)  
